...
embed questions for the semantic answer cache, and a plain text loader, used
to read an uploaded document into the corpus that is preloaded into context.
...
def get_query_embeddings():
    """The embedder used to embed a question for the semantic cache."""
